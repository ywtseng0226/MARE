        ...
        for batch_inputs, targets in track(data_loader):
            ...
            for i in range(preds.shape[0]):
                ...
                if cfg.data.datasets.type == 'NYUv2':
                    ...
                    file_path = osp.join(output_dir, batch_inputs["sequence"][i], batch_inputs['frame_id'][i] + '.pkl')
                ...
                os.makedirs(osp.join(output_dir, batch_inputs["sequence"][i]), exist_ok=True)
